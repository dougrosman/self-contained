...
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    layer_specs = [
        ...
        a.ngf * 16, # encoder_8: [batch, 2, 2, ngf * 8] => [batch, 1, 1, ngf * 8]
    ]
    ...
    layer_specs = [
        ...
        (a.ngf * 4, 0.0),   # decoder_5: [batch, 32, 32, ngf * 8 * 2] => [batch, 64, 64, ngf * 8 * 2]
        (a.ngf * 2, 0.0),   # decoder_4: [batch, 64, 64, ngf * 8 * 2] => [batch, 128, 128, ngf * 4 * 2]
        (a.ngf, 0.0),   # decoder_3: [batch, 128, 128, ngf * 4 * 2] => [batch, 256, 256, ngf * 2 * 2]
    ]
